...
// .wrangler/tmp/bundle-ZWp3uL/checked-fetch.js
...
async function concatenateMP3Files(audioBuffers) {
...
__name(concatenateMP3Files, "concatenateMP3Files");
var src_default = {
  async fetch(request, env, ctx) {
    ...
    try {
      audioSegments.sort((a, b) => (a.startMs ?? 0) - (b.startMs ?? 0));
      const audioBuffers = [];
...
// .wrangler/tmp/bundle-ZWp3uL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZWp3uL/middleware-loader.entry.ts
